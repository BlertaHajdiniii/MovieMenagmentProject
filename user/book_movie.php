...
//Enssures that the user is logged in
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($conn->query($sql) == TRUE){
        echo "<div class='container'><p class= 'alert alert-success'>Booking sucessful! Your booking is pending to be approved</p></div>";
